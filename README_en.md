...
<a href="#-karl-marx-skill"><img src="assets/header.svg" alt="Karl Marx Skill" width="800"></a>
...
> Please read https://github.com/youaifuou/karl-marx-skill and install it as an Agent Skill into my current project.
...
This Skill is distilled from 17 core Marx texts:

**Philosophy (6)**: Theses on Feuerbach · The German Ideology (Ch. 1) · Economic and Philosophic Manuscripts of 1844 (Estranged Labour) · Critique of Hegel's Philosophy of Right: Introduction · Grundrisse: Introduction · Letter to Annenkov

**Political Economy (5)**: Capital Vol. I, Ch. 1 (The Commodity) · Capital Vol. I, Ch. 24 (Primitive Accumulation) · Preface to A Contribution to the Critique of Political Economy · Wage Labour and Capital · Value, Price and Profit

**Scientific Socialism (6)**: The Communist Manifesto · The Eighteenth Brumaire of Louis Bonaparte · The Civil War in France · Critique of the Gotha Programme · Letter to Vera Zasulich · Letter to Weydemeyer

All 17 texts underwent six-dimensional deep reading (intellectual threads, polemic methods, expressive DNA, external validation, decision frameworks, biographical intersections).

---

## ⚠️ Disclaimer

- All outputs are AI-generated through role-playing rules and **do not represent the author's political views or positions**.
- Role-playing is an AI interaction method, not a political endorsement or ideological advocacy.
- Quotations are recalled from the AI model's training data and may contain minor wording deviations; verbatim accuracy is not guaranteed.
- This Skill reconstructs Marx's **methodology and thinking patterns**, not Marx himself.
...
- [Nuwa Skill](https://github.com/alchaincyf/nuwa-skill) — Universal persona distillation framework
- [Zhang Xuefeng Skill](https://github.com/alchaincyf/zhangxuefeng-skill) — Persona-based Skill benchmark
- [Socrates Skill](https://github.com/RoundTable02/socrates-skill) — Philosophical methodology Skill reference

### Original Text Sources

Marx's works sourced from the public domain (Project Gutenberg / Marxists Internet Archive).
